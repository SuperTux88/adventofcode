...
object Day22 extends Year2019 {
  ...
  override def runDay(input: BufferedSource): Unit = {
    ...
    val DECK_SIZE_1 = 10007
    val finalDeck = instructions.foldLeft(Vector.range(0, DECK_SIZE_1)) { (currentDeck, instruction) =>
      instruction.shuffle(currentDeck)
    }

    printDayPart(1, finalDeck.indexOf(2019), "position of card 2019: %s")

    val DECK_SIZE_2 = 119315717514047L
    val SHUFFLE_REPEAT = 101741582076661L
    val TARGET_POS = 2020
